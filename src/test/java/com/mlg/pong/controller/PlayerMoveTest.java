...
//        controller = new Player1Controller(game);
//        initial = new ArrayList<>();
//        for (Player p : game.getPlayer2()) {
...
//            Assertions.assertEquals(UP, game.getPlayer2().get(i).getPosition());
//        }
//    }
//
//    @Test
//    void movePlayerUpWall() {
//        while(!game.getPlayer2().get(0).getPosition().equals(max.get(0))) { // Reach Max Height
//            controller.movePlayerUp();
//        }
...
//            Assertions.assertEquals(P,game.getPlayer2().get(i).getPosition());
//        }
//    }
//
//    @Test
...
//            Assertions.assertEquals(DOWN, game.getPlayer2().get(i).getPosition());
//        }
//    }
//
//    @Test
//    void movePlayerDownWall() {
//        while(!game.getPlayer2().get(0).getPosition().equals(min.get(0))) { // Reach Min Height
//            controller.movePlayerDown();
//        }
//
